...
export interface EventsRepository {
  subscribeToEvents(
    householdId: string,
    cb: (events: KidEvent[]) => void,
    onError?: (error: unknown) => void,
  ): Unsubscribe;
  createEvent(householdId: string, uid: string, input: NewEventInput): Promise<void>;
  updateEvent(householdId: string, eventId: string, uid: string, input: NewEventInput): Promise<void>;
