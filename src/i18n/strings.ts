...
export const strings = {
  ...
  auth: {
    ...
    googleHint: 'Usa tu cuenta de Google, o crea una cuenta con tu correo.',
    ...
    email: {
      ...
      reset: {
        ...
        body: 'Ingresa tu correo y te enviaremos un enlace para elegir una contraseña nueva.',
    ...
    verify: {
      ...
      body: (email: string) =>
        `Te enviamos un enlace de verificación a ${email}. Ábrelo y luego vuelve aquí.`,
      resend: 'Reenviar correo',
      resendSent: 'Correo reenviado.',
      confirm: 'Ya verifiqué mi correo',
      notYetVerified: 'Todavía no verificamos tu correo. Intenta de nuevo en un momento.',
    },
  },
